...
using Voxstrap.Models.APIs;
using CommunityToolkit.Mvvm.Input;

namespace Voxstrap.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for Voxstraprpc, discord rich presence, or game history
