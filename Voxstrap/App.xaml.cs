...
namespace Voxstrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Voxstrap-QA";
#else
        public const string ProjectName = "Voxstrap";
#endif
        public const string ProjectOwner = "Voxstrap";
        public const string ProjectRepository = "Voxstraplabs/Voxstrap";
        public const string ProjectDownloadLink = "https://Voxstraplabs.com";
        public const string ProjectHelpLink = "https://Voxstraplabs.com/wiki/help/";
        public const string ProjectSupportLink = "https://github.com/Voxstraplabs/Voxstrap/issues/new";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructVoxstrapWebUrl();
        ...
        public static string ConstructVoxstrapWebUrl()
        {
            ...
            if (Settings.Prop.WebEnvironment == WebEnvironment.Production || !Settings.Prop.DeveloperMode)
                return "services.Voxstraplabs.com";

            string? sub = Settings.Prop.WebEnvironment.GetDescription();
            return $"services-{sub}.Voxstraplabs.com";
        }
