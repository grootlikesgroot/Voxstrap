...
namespace Voxstrap
{
    public static class LaunchHandler
    {
        ...
        public static void LaunchBackgroundUpdater()
        {
            ...
            App.Bootstrapper = new Bootstrapper(launchMode)
            {
                MutexNamePrefix = "Voxstrap-BackgroundUpdater",
            ...
            Task.Run(() =>
            {
                ...
                using (EventWaitHandle handle = new EventWaitHandle(false, EventResetMode.AutoReset, "Voxstrap-BackgroundUpdaterKillEvent"))
                    handle.WaitOne();
