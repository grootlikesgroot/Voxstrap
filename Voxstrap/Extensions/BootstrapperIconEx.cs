...
namespace Voxstrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconVoxstrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconVoxstrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconVoxstrap => Properties.Resources.IconVoxstrap,
                ...
                BootstrapperIcon.IconVoxstrapClassic => Properties.Resources.IconVoxstrapClassic,
                _ => Properties.Resources.IconVoxstrap
            };
        }
    }
}
