...
namespace Voxstrap
{
    internal class Installer
    {
        ...
        public void DoInstall()
        {
            ...
            // only register player, for the scenario where the user installs Voxstrap, closes it,
        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "2.8.0") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "Voxstrap");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\Voxstrap", false);
...
#pragma warning disable CS0162 // Unreachable code detected
                if (OpenReleaseNotes)
                {
                    ...
                    Utilities.ShellExecute($"https://github.com/{App.ProjectRepository}/wiki/Release-notes-for-Voxstrap-v{releaseNoteVersion}");
                }
