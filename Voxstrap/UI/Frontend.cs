...
using Voxstrap.UI.Elements.Bootstrapper;
using Voxstrap.UI.Elements.Dialogs;

namespace Voxstrap.UI
{
    static class Frontend
    {
        ...
        public static void ShowPlayerErrorDialog(bool crash = false)
        {
            ...
            string info = String.Format(
                ...
                $"https://Voxstraplabs.com/wiki/help/roblox-crashes-or-does-not-launch/"
            );
        ...
        private static IBootstrapperDialog GetCustomBootstrapper()
        {
            ...
            catch (Exception ex)
            {
                ...
                if (!App.LaunchSettings.QuietFlag.Active)
                    ShowMessageBox(string.Format(Strings.CustomTheme_Errors_SetupFailed, ex.Message, "Voxstrap"), MessageBoxImage.Error); // NOTE: Voxstrap is the theme name
        ...
        public static void ShowBalloonTip(string title, string message, System.Windows.Forms.ToolTipIcon icon = System.Windows.Forms.ToolTipIcon.None, int timeout = 5)
        {
            ...
            {
                Icon = Properties.Resources.IconVoxstrap,
