...
namespace Voxstrap.UI.ViewModels.About
{
    public class SupportersViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public async void LoadSupporterData()
        {
            ...
            try
            {
                SupporterData = await Http.GetJson<SupporterData>("https://raw.githubusercontent.com/Voxstraplabs/config/main/supporters.json");
            }
            catch (Exception ex)
            {
