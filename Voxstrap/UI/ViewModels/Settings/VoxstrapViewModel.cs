...
{
    public class VoxstrapViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private void ExportData()
        {
            ...
            { 
                FileName = $"Voxstrap-export-{timestamp}.zip",
        ...
        {
            const string LOG_IDENT = "VoxstrapViewModel::AddFilesToZipStream";
