...
using Voxstrap.UI.Elements.Settings;
using Voxstrap.UI.Elements.Editor;
using Voxstrap.UI.Elements.Dialogs;

namespace Voxstrap.UI.ViewModels.Settings
{
            ...
            set
            {
                if (String.IsNullOrEmpty(value))
                {
                    if (App.Settings.Prop.BootstrapperIcon == BootstrapperIcon.IconCustom)
                        App.Settings.Prop.BootstrapperIcon = BootstrapperIcon.IconVoxstrap;
                }
                else
                {
