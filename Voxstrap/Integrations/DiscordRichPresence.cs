...
using Voxstrap.Models.RobloxApi;
using DiscordRPC;

namespace Voxstrap.Integrations
{
    public class DiscordRichPresence : IDisposable
    {
        ...
        private void ProcessSetRichPresence(Message message, bool implicitUpdate)
        {
            ...
            Models.VoxstrapRPC.RichPresence? presenceData;
            ...
            try
            {
                presenceData = message.Data.Deserialize<Models.VoxstrapRPC.RichPresence>();
            }
            catch (Exception)
            {
        ...
        public async Task<bool> SetCurrentGame()
        {
            ...
            // this is used for configuration from VoxstrapRPC
